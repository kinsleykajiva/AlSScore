...
class ProcessMiner(object):
	...
	def saveModelClassifier(self,modeFileName, data_features ,y_train__ ):	
		...
		utils.saveClassifier( classifierEstimator , modeFileName)
...
# access = ProcessMiner("model0006" , "to replicate the experiment you need to know how much vinegar to put in the containers there needs to be a control and you also need to know the shape of the objects because shape could have an effect on how much material gets dissolved")
...
# 	#save model to file	
# 	access.saveModelClassifier(access.MODEL_FILE , train_data_features , y_train )
